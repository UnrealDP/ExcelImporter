...
Instructions
Define data in Plugins/ExcelImporter/Content/DT_DataTypeSettings.uasset.
...
Define the import settings in Plugins/ExcelImporter/Content/DT_ExcelImportSettings.uasset.
...
Open the Unreal Editor and go to Window > ImportExcelData to open the import popup.

Select the checkbox for the Excel file you wish to convert.

Click the Generate Selected to C++ Header button.

Once the header file is generated, the Unreal Editor will automatically restart to ensure correct application.

After restarting, open Window > ImportExcelData in the Unreal Editor again.

Select the checkbox for the Excel data you want to convert to a DataTable.

Click the Create DataTable button to generate the DataTable.
